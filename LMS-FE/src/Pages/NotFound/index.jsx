  ...
  return (
    <main className='w-full h-screen flex flex-col justify-between gap-8 items-center py-5 px-6'>
      <div className='flex items-center gap-3 self-start'>
        ...
        <h3 className='text-md font-bold'>Hệ Thống Quản Lý Học Tập</h3>
      </div>
      ...
      <p className='font-bold text-gray-500'>© 2024 - 2025 Đại học Bách Khoa Hà Nội. All rights reserved.</p>
    </main>
  );
}
