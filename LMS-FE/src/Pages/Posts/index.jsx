          ...
          <section className='pb-5 md:w-9/12 md:py-5 lg:w-10/12'>
            ...
            <div className='mt-7'>
              ...
              <div className='border-b-[1px] pb-3'>
                ...
                <h2 className='text-xl font-semibold'>Tổng hợp các sản phẩm của sinh viên Bách Khoa</h2>
                ...
                <p className='text-sm text-justify'>
                  ...
                  Đó là khi Hệ thống của chúng tôi ra đời, với lộ trình rõ ràng, bài học được chia ra rạch ròi, course-mate
                  ...
                  không thu phí. Hệ thống cho ta một con đường rõ ràng, không lan man, có thế tiết kiệm được vài tháng đến cả
