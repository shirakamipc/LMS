      ...
      <div className=' lg:px-8 xl:px-14 pt-7 pb-10'>
        ...
        <section className='flex gap-8 flex-wrap lg:flex-nowrap'>
          <div className='flex justify-between lg:justify-start p-5 gap-6 rounded-xl border-2 w-full lg:w-auto'>
            <div className='w-auto lg:max-w-[320px]'>
              ...
              <p className='text-gray-700 mb-4 text-justify'>
                Lập trình viên Front-end là người xây dựng ra giao diện websites. Trong phần này chúng tôi sẽ chia sẻ cho bạn
          ...
          <div className='flex justify-between  lg:justify-start p-5 gap-6 rounded-xl border-2 w-full lg:w-auto'>
            <div className='w-auto lg:max-w-[320px]'>
              <h2 className='text-2xl font-extrabold mb-4'>Lộ trình học Front-end</h2>
              <p className='text-gray-700 mb-4 text-justify'>
                Lập trình viên Back-end là người xây dựng ra logic xử lý phía server. Trong phần này chúng tôi sẽ chia sẻ cho bạn
                lộ trình để trở thành lập trình viên Back-end nhé.
              </p>
        ...
        <section className='flex justify-between items-center'>
          <div className='w-10/12 md:max-w-[400px] py-7'>
            <h1 className='text-2xl font-extrabold mb-4'>Tham gia cộng đồng sinh viên Bách Khoa trên Facebook</h1>
