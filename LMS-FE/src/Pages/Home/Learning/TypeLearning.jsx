    ...
    <>
      <main className='pl-8'>
        <section className='max-w-[840px] mb-7 md:mb-14 text-sm md:text-base font-medium md:font-normal'>
          ...
          <p className='text-justify mb-3'>
            Dưới đây là các khóa học của chúng tôi dành cho bất cứ ai theo đuổi sự nghiệp trở thành một lập trình viên
            Back-end.
          </p>
          <blockquote className='relative text-justify before:w-1 px-3 before:h-full ml-4 before:absolute before:top-0 before:left-0 before:bg-orange-400 before:content-[""]'>
            <p>Các khóa học có thể chưa đầy đủ, chúng tôi vẫn đang nỗ lực hoàn thiện trong thời gian sớm nhất.</p>
          </blockquote>
        </section>
