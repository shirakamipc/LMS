...
*/
-- DropForeignKey
ALTER TABLE "course_in_path" DROP CONSTRAINT "course_in_path_courseId_fkey";

-- DropForeignKey
ALTER TABLE "course_in_path" DROP CONSTRAINT "course_in_path_learningPathId_fkey";
